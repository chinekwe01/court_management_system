       ...
       <div class="h-full mb-4 rounded relative overflow-x-auto">
            ...
            <td class="px-6 py-4">
                ...
                <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                    ...
                    <li>
                        <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">View Case</a>
                    </li>
                    <li>
                        <button id="defaultModalButton" data-modal-toggle="editCaseModal" class="px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit Case</button>
                    </li>
                    <li>
                        <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Delete Case</a>
                    </li>
